-module(qlc_test_otp_6359). -import(qlc_SUITE, [i/1,i/2,format_info/2]). -import(qlc_SUITE, [etsc/2, etsc/3]). -import(qlc_SUITE, [create_ets/2]). -import(qlc_SUITE, [strip_qlc_call/1]). -import(qlc_SUITE, [join_info/1]). -import(qlc_SUITE, [join_info_count/1]). -import(qlc_SUITE, [lookup_keys/1]). -include_lib("stdlib/include/qlc.hrl"). function() -> T = luna, Fname = "/buildroot/otp/lib/stdlib/make_test_dir/ct_logs/ct_run.test_server@ce997628b9a6.2024-06-03_18.22.38/make_test_dir.stdlib_test.logs/run.2024-06-03_18.23.14/log_private/luna",
           ...
           [] = qlc:eval(Q),
           ok = dets:close(T),
           file:delete("/buildroot/otp/lib/stdlib/make_test_dir/ct_logs/ct_run.test_server@ce997628b9a6.2024-06-03_18.22.38/make_test_dir.stdlib_test.logs/run.2024-06-03_18.23.14/log_private/luna"),
           ok, ok. 